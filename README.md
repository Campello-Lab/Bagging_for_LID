...
#### This repository has been developed for the paper titled "On the Use of Bagging for Local Intrinsic Dimensionality Estimation" with preprint published on [arXiv](https://arxiv.org/abs/2603.24384), as well as part of a master's thesis project viewable at [Master's Thesis](Papers/On_the_Use_of_Bagging_for_Local_Intrinsic_Dimensionality_Estimation__Master_s_Thesis.pdf).
