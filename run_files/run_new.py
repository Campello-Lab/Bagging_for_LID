...
if __name__ == "__main__":
    ...
    resultsk = new_result_generator(param_dictsk, multiprocess=True, load=False, load_data=False, worker_count=None,
                                   save_name='uniform_plot_k',
                                   directory=r'C:\Users\User\PycharmProjects\pythonProject3\LIDstuff\saved_results\pkls2')

    resultssr = new_result_generator(param_dictssr, multiprocess=True, load=False, load_data=False, worker_count=None,
                                   save_name='uniform_plot_sr',
                                   directory=r'C:\Users\User\PycharmProjects\pythonProject3\LIDstuff\saved_results\pkls2')

    resultsn = new_result_generator(param_dictsn, multiprocess=True, load=False, load_data=False, worker_count=None,
    ...
    results = new_result_generator(param_dicts_compare_mle_k, multiprocess=True, load=False, load_data=True, worker_count=None,
                                   save_name='compare_mle_k',
                                   directory=r'C:\Users\User\PycharmProjects\pythonProject3\LIDstuff\saved_results\pkls2')

    #param_dicts_compare_mada_k
    results = new_result_generator(param_dicts_compare_mada_k, multiprocess=True, load=False, load_data=True, worker_count=None,
                                   save_name='compare_mada_k',
                                   directory=r'C:\Users\User\PycharmProjects\pythonProject3\LIDstuff\saved_results\pkls2')

    #param_dicts_compare_tle_k
    results = new_result_generator(param_dicts_compare_tle_k, multiprocess=True, load=False, load_data=True, worker_count=None,
                                   save_name='compare_tle_k',
                                   directory=r'C:\Users\User\PycharmProjects\pythonProject3\LIDstuff\saved_results\pkls2')
    ...
    results = new_result_generator(param_dicts_compare_tle_sr, multiprocess=True, load=False, load_data=True, worker_count=None,
                                   save_name='compare_tle_sr',
                                   directory=r'C:\Users\User\PycharmProjects\pythonProject3\LIDstuff\saved_results\pkls2')
    ...
    results = new_result_generator(param_dicts_compare_tle_lid, multiprocess=True, load=False, load_data=True, worker_count=None,
                                   save_name='compare_tle_lid',
                                   directory=r'C:\Users\User\PycharmProjects\pythonProject3\LIDstuff\saved_results\pkls2')

    #param_dicts_compare_mle_k_sm
    results = new_result_generator(param_dicts_compare_mle_k_sm, multiprocess=True, load=False, load_data=True, worker_count=None,
                                   save_name='compare_mle_k_sm',
                                   directory=r'C:\Users\User\PycharmProjects\pythonProject3\LIDstuff\saved_results\pkls2')

    #param_dicts_compare_mada_k_sm
    results = new_result_generator(param_dicts_compare_mada_k_sm, multiprocess=True, load=False, load_data=True, worker_count=None,
    ...
    results = new_result_generator(param_dicts_compare_mle_sr_sm, multiprocess=True, load=False, load_data=True, worker_count=None,
                                   save_name='compare_mle_sr_sm',
                                   directory=r'C:\Users\User\PycharmProjects\pythonProject3\LIDstuff\saved_results\pkls2')

    #param_dicts_compare_mada_sr_sm
    results = new_result_generator(param_dicts_compare_mada_sr_sm, multiprocess=True, load=False, load_data=True, worker_count=None,
                                   save_name='compare_mada_sr_sm',
                                   directory=r'C:\Users\User\PycharmProjects\pythonProject3\LIDstuff\saved_results\pkls2')

    #param_dicts_compare_tle_sr_sm
    results = new_result_generator(param_dicts_compare_tle_sr_sm, multiprocess=True, load=False, load_data=True, worker_count=None,
                                   save_name='compare_tle_sr_sm',
                                   directory=r'C:\Users\User\PycharmProjects\pythonProject3\LIDstuff\saved_results\pkls2')

    #param_dicts_compare_mle_lid_sm
    results = new_result_generator(param_dicts_compare_mle_lid_sm, multiprocess=True, load=False, load_data=True, worker_count=None,
                                   save_name='compare_mle_lid_sm',
                                   directory=r'C:\Users\User\PycharmProjects\pythonProject3\LIDstuff\saved_results\pkls2')

    #param_dicts_compare_mada_lid_sm
    results = new_result_generator(param_dicts_compare_mada_lid_sm, multiprocess=True, load=False, load_data=True, worker_count=None,
                                   save_name='compare_mada_lid_sm',
                                   directory=r'C:\Users\User\PycharmProjects\pythonProject3\LIDstuff\saved_results\pkls2')

    #param_dicts_compare_tle_lid_sm
    results = new_result_generator(param_dicts_compare_tle_lid_sm, multiprocess=True, load=False, load_data=True, worker_count=None,
                                   save_name='new_interaction_plot_n_k',
                                   directory=r'C:\Users\User\PycharmProjects\pythonProject3\LIDstuff\saved_results\pkls2')
