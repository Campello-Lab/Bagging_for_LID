...
from LIDBagging.Datasets.dataset_collections import *
#-----------------------------------------------------------------------------------------------------------------------
def param_dicts_general(base_param_dict, variants_test_types, estimator_names, test_name='test'):
    param_dicts_dict = {}
...
interaction_sr_k_test_base_param_dict = {'dataset_name': dataset_name_strings,
                    ...
                    'Nbag': k_prog_sampling_rate_k_interaction,
                    'pre_smooth': None,
                    'post_smooth': None,
                    't': 1}
