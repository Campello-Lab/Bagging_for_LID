...
worker_count=7
save_name='light_mergedresult' #Save and load .pkl files with this name prefix.
pkl_directory = r'Output/Complete_experiment_pkl_files/light_experiments' #Directory for saving and loading
